...
// Standard emoji-free reactions — text labels
export const Reaction = ({ kind }: { kind: "thumbs" | "clap" | "heart" | "laugh" }) => {
  const labels = { thumbs: "Thumbs", clap: "Clap", heart: "Love", laugh: "Laugh" };
  return <span className="text-xs font-medium">{labels[kind]}</span>;
};
